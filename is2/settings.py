...
SECRET_KEY = '8y6)x9no+f3!^y5db3nttky37$arx%(^akea5!*7rq)$2)nuzp'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries': {
                'my_templatetag': 'adquisiciones.templatetags.my_templatetag',
            }
        },
    },
]
...
EMAIL_HOST_PASSWORD = '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'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
